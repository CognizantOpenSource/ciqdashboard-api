...
import static com.cognizant.idashboardapi.models.Type.DateType.*;
...
public class DateFilterComponent {
    ...
    public Filter getMinAndMaxDate(Filter filter) {
        ...
        switch (filter.getOp()) {
            case thisYear:
                Date firstDayOfCurrentYear = firstDayOfCurrentYearOrMonthOrWeek(calendar, YEAR);
                ...
                break;
            case thisMonth:
                Date firstDayOfCurrentMonth = firstDayOfCurrentYearOrMonthOrWeek(calendar, MONTH);
                filter.setValue(firstDayOfCurrentMonth.toInstant().toString());
                filter.setMaxValue(calendar.getTime().toInstant().toString());
                filter.setOp(between);
                break;
            case thisWeek:
                Date firstDayOfCurrentWeek = firstDayOfCurrentYearOrMonthOrWeek(calendar, WEEK);
            ...
            case thisDay:
                ...
                break;
            case lastNYear:
                Date firstDayOfNthYear = firstDayOfNthYearOrMonthOrWeekOrDay(calendar, YEAR, value);
...
//                filter.setMaxValue(lastDayOfLastYear.toInstant().toString());
                ...
                break;
            case lastNMonth:
                Date firstDayOfNthMonth = firstDayOfNthYearOrMonthOrWeekOrDay(calendar, MONTH, value);
...
//                filter.setMaxValue(lastDayOfLastMonth.toInstant().toString());
                ...
                break;
            case lastNWeek:
                Date firstDayOfNthWeek = firstDayOfNthYearOrMonthOrWeekOrDay(calendar, WEEK, value);
...
//                filter.setMaxValue(lastDayOfLastWeek.toInstant().toString());
                ...
                break;
            case lastNDay:
                Date firstDayOfNthDay = firstDayOfNthYearOrMonthOrWeekOrDay(calendar, DAY, value);
